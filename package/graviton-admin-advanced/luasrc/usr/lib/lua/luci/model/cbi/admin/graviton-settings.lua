...
local m = Map("autoupdater", translate("Automatic updates"))
m.pageaction = false
...
local m2 = Map("system", translate("SSH keys"))
m2.pageaction = false
m2.template = "admin/expertmode"

if fs.access("/etc/config/dropbear") then
  local s = m2:section(TypedSection, "_dummy1", nil,
...
local m3 = Map("system", translate("Password"))
m3.reset = false
m3.pageaction = false
m3.template = "admin/expertmode"

local s = m3:section(TypedSection, "_dummy2", nil, translate(
